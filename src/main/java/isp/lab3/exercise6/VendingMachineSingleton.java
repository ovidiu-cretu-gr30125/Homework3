...
public class VendingMachineSingleton {
    private static VendingMachine singleInstance=null;
    private String product;
    private int credit;
    private int totalNumberOfProducts=5;
    private int [] price = new int[5];
    private int [] numberOfSpecificProduct = new int [5];
    private String [] Products = new String[totalNumberOfProducts];
    private VendingMachineSingleton(int totalNumberOfProducts){
    ...
    public static VendingMachine getSingleInstance(){
        if(singleInstance==null){
            singleInstance = new VendingMachine(5);
        }
